...
var validateDetails = function() {
  ...
  if (moviename.val() == "") {
    notification.MaterialSnackbar.showSnackbar(
      {
        message: "Movie name Can't  Empty!"
      }
    );
    moviename.focus();
    return false;
  ...
  else if (trailerUrl.val() == "") {
    notification.MaterialSnackbar.showSnackbar(
      {
        message: "Trailer Url also Required!"
      }
    );
    trailerUrl.focus();
    return false;
...
gapi.signin.render("googleSignIn", {
              'clientid': '81122361520-1d7ov4do2cj3a55n0c2g57v1ilphrldn.apps.googleusercontent.com',
